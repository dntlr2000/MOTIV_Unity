...
public class Enemy_Health : MonoBehaviour
{
    ...
    // Phase scripts
    public EnemyDrone_phase1 phase1Script;
    public EnemyDrone_phase2 phase2Script;
    ...
    void Start()
    {
        ...
        UpdatePhaseScripts(); // 생명 수에 따라 스크립트 활성화/비활성화
    ...
    private void UpdatePhaseScripts()
    {
        if (phase1Script != null)
        {
            phase1Script.enabled = (life == 1 || life == 3); // 생명 수가 1 또는 3일 때 활성화
        }
